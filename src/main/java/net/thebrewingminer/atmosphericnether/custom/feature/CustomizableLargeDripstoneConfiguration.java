...
public class CustomizableLargeDripstoneConfiguration extends LargeDripstoneConfiguration {
    public static final Codec<CustomizableLargeDripstoneConfiguration> CODEC = RecordCodecBuilder.create(instance ->
            instance.group(
                    ...
                    IntProvider.CODEC.fieldOf("column_radius").forGetter(cfg -> cfg.columnRadius),
                    FloatProvider.CODEC.fieldOf("stalactite_bluntness").forGetter(cfg -> cfg.stalactiteBluntness),
                    FloatProvider.CODEC.fieldOf("stalagmite_bluntness").forGetter(cfg -> cfg.stalagmiteBluntness),
                    FloatProvider.CODEC.fieldOf("height_scale").forGetter(cfg -> cfg.heightScale),
                    FloatProvider.CODEC.fieldOf("wind_speed").forGetter(cfg -> cfg.windSpeed),
                    Codec.intRange(1, 128).fieldOf("min_radius_for_wind").forGetter(cfg -> cfg.minRadiusForWind),
                    Codec.floatRange(0.0F, 5.0F).fieldOf("min_bluntness_for_wind").forGetter(cfg -> cfg.minBluntnessForWind),
                    Codec.intRange(1, 512).fieldOf("floor_to_ceiling_search_range").forGetter(cfg -> cfg.floorToCeilingSearchRange),
